...
rename variables kern=gebiedscode.
rename variables Namekern=naam_kort.
string naam (a55).
...
SAVE TRANSLATE OUTFILE='C:\github\gebiedsniveaus\data_voor_swing\gebiedsdefinities\kern.xlsx'
  /TYPE=XLS
  /VERSION=12
  /MAP
