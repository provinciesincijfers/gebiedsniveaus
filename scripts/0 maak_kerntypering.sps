...
AGGREGATE
  /OUTFILE='werkbestand'
  /BREAK=kerntypering Namekerntypering
  /N_BREAK=N.
dataset activate werkbestand.
delete variables n_break.
rename variables kerntypering=gebiedscode.
rename variables Namekerntypering=naam_kort.
string naam (a55).
...
SAVE TRANSLATE OUTFILE='C:\github\gebiedsniveaus\data_voor_swing\gebiedsdefinities\kerntypering.xlsx'
  /TYPE=XLS
  /VERSION=12
  /MAP
