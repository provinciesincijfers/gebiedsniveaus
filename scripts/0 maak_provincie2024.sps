...
DATASET DECLARE provincie2024.
AGGREGATE
  /OUTFILE='provincie2024'
  /BREAK=provincie2024 provincie2024_naam
  /N_BREAK=N.
dataset activate provincie2024.
delete variables n_break.
rename variables provincie2024=gebiedscode.
rename variables provincie2024_naam=naam_kort.
string naam (a44).
...
SAVE TRANSLATE OUTFILE='C:\github\gebiedsniveaus\data_voor_swing\gebiedsdefinities\provincie2024.xlsx'
  /TYPE=XLS
  /VERSION=12
  /MAP
