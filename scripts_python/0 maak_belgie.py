# -*- coding: utf-8 -*-
"""
Created on Thu Aug  7 15:20:54 2025
...
input_path = base_path / "kerntabellen//gewest_belgie.xlsx"
output_path = base_path / "data_voor_swing//gebiedsdefinities//belgie.xlsx"

# Laad Excel-bestand
col_names = ['gewest', 'Name gewest', 'belgie', 'Name belgie']
dtypes = {'gewest':'Int64', 'Name gewest': 'string', 'belgie':'Int64', 'Name belgie':'string'} 
...
df_grouped = df.groupby(['belgie', 'Name belgie']).size().reset_index(name='aantal_gebieden')

# Datasetbewerking
df_grouped = df_grouped.drop(columns=['aantal_gebieden'])
df_grouped = df_grouped.rename(columns={
    'belgie': 'geoitem code',
    'Name belgie': 'short name'
})
