...
output_path = base_path / "data_voor_swing//gebiedsdefinities//deelgemeente.xlsx"
...
df_grouped = df.groupby(["deelgemeente", "deelgemeente_naam", "deelgemeente_naam_kort"]).size().reset_index(name="aantal_gebieden")


# Datasetbewerking
df_grouped = df_grouped.drop(columns=["aantal_gebieden"])
df_grouped = df_grouped.rename(columns={
    "deelgemeente": "geoitem code",
    "deelgemeente_naam_kort": "short name",
    "deelgemeente_naam": "name"
})
