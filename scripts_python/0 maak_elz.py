# -*- coding: utf-8 -*-
"""
Created on Fri Aug  8 08:47:54 2025
...
input_path = base_path / "kerntabellen//gemeente_elz.xls"
output_path = base_path / "data_voor_swing//gebiedsdefinities//elz.xlsx"

# Laad Excel-bestand
col_names = ['gemeente', 'Name gemeente', 'elz', 'Name elz']
dtypes = {'gemeente':'Int64', 'Name gemeente': 'string', 'elz':'string', 'Name elz':'string'} 
...
df_grouped = df.groupby(['elz', 'Name elz']).size().reset_index(name='aantal_gebieden')
...
df_grouped["onbekend_gebied"] = df_grouped["geoitem code"].astype(str).isin(["elz91", "elz92", "elz93", "elz99"]).astype(int)
