# -*- coding: utf-8 -*-
"""
Created on Fri Aug  8 10:45:18 2025
...
output_path = base_path / "data_voor_swing//gebiedsdefinities//gemeente2018.xlsx"
...
df_grouped = df.groupby(['gemeente2018', 'gemeente2018_naam']).size().reset_index(name='aantal_gebieden')

# Datasetbewerking
df_grouped = df_grouped.drop(columns=['aantal_gebieden'])
df_grouped = df_grouped.rename(columns={
    'gemeente2018': 'geoitem code',
    'gemeente2018_naam': 'short name'
})
