# -*- coding: utf-8 -*-
"""
Created on Fri Aug  8 11:15:24 2025
...
input_path = base_path / "kerntabellen//provincie_gewest.xls"
output_path = base_path / "data_voor_swing//gebiedsdefinities//gewest.xlsx"

# Laad Excel-bestand
col_names = ['provincie', 'Name provincie', 'gewest', 'Name gewest']
dtypes = {'provincie':'Int64', 'Name provincie': 'string', 'gewest':'Int64', 'Name gewest':'string'} 
...
df_grouped = df.groupby(['gewest', 'Name gewest']).size().reset_index(name='aantal_gebieden')

# Datasetbewerking
df_grouped = df_grouped.drop(columns=['aantal_gebieden'])
df_grouped = df_grouped.rename(columns={
    'gewest': 'geoitem code',
    'Name gewest': 'short name'
})
