# -*- coding: utf-8 -*-
"""
Created on Fri Aug  8 13:38:24 2025
...
input_path = base_path / "kerntabellen//statsec_kern.xlsx"
output_path = base_path / "data_voor_swing//gebiedsdef_testpython//kern.xlsx"

# Laad Excel-bestand
col_names = ['statsec', 'Name statsec', 'kern', 'Name kern']
dtypes = {'statsec':'string', 'Name statsec': 'string', 'kern':'string', 'Name kern':'string'} 
...
df_grouped = df.groupby(['kern', 'Name kern']).size().reset_index(name='aantal_gebieden')

# Datasetbewerking
df_grouped = df_grouped.drop(columns=['aantal_gebieden'])
df_grouped = df_grouped.rename(columns={
    'kern': 'geoitem code',
    'Name kern': 'short name'
})
