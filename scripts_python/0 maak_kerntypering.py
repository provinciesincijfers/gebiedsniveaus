# -*- coding: utf-8 -*-
"""
Created on Fri Aug  8 13:47:09 2025
...
input_path = base_path / "kerntabellen//statsec_kerntypering.xlsx"
output_path = base_path / "data_voor_swing//gebiedsdef_testpython//kerntypering.xlsx"

# Laad Excel-bestand
col_names = ['statsec', 'Name statsec', 'kerntypering', 'Name kerntypering']
dtypes = {'statsec':'string', 'Name statsec': 'string', 'kerntypering':'Int64', 'Name kerntypering':'string'} 
...
df_grouped = df.groupby(['kerntypering', 'Name kerntypering']).size().reset_index(name='aantal_gebieden')

# Datasetbewerking
df_grouped = df_grouped.drop(columns=['aantal_gebieden'])
df_grouped = df_grouped.rename(columns={
    'kerntypering': 'geoitem code',
    'Name kerntypering': 'short name'
})
