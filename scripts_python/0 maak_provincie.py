# -*- coding: utf-8 -*-
"""
Created on Fri Aug  8 14:42:10 2025
...
output_path = base_path / "data_voor_swing//gebiedsdefinities//provincie.xlsx"
...
df_grouped = df.groupby(['provincie', 'provincie_naam']).size().reset_index(name='aantal_gebieden')

# Datasetbewerking
df_grouped = df_grouped.drop(columns=['aantal_gebieden'])
df_grouped = df_grouped.rename(columns={
    'provincie': 'geoitem code',
    'provincie_naam': 'short name'
})
