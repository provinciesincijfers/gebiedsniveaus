# -*- coding: utf-8 -*-
"""
Created on Mon Aug 11 09:27:33 2025
...
input_path = base_path / "kerntabellen//gemeente_streekwerking.xlsx"
output_path = base_path / "data_voor_swing//gebiedsdefinities//streekwerking.xlsx"

# Laad Excel-bestand
col_names = ['gemeente', 'Name gemeente', 'streekwerking', 'Name gebied streekwerking']
dtypes = {'gemeente':'Int64', 'Name gemeente': 'string', 'streekwerking':'string', 'Name gebied streekwerking':'string'} 
...
df_grouped = df.groupby(['streekwerking', 'Name gebied streekwerking']).size().reset_index(name='aantal_gebieden')

# Datasetbewerking
df_grouped = df_grouped.drop(columns=['aantal_gebieden'])
df_grouped = df_grouped.rename(columns={
    'streekwerking': 'geoitem code',
    'Name gebied streekwerking': 'short name'
})
