# -*- coding: utf-8 -*-
"""
Created on Mon Aug 11 09:38:24 2025
...
input_path = base_path / "kerntabellen//statsec_treg.xlsx"
output_path = base_path / "data_voor_swing//gebiedsdefinities//treg.xlsx"

# Laad Excel-bestand
col_names = ['statsec', 'NAME statsec', 'TREG', 'NAME TREG']
dtypes = {'statsec':'string', 'NAME statsec': 'string', 'TREG':'string', 'NAME TREG':'string'} 
...
df_grouped = df.groupby(['TREG', 'NAME TREG']).size().reset_index(name='aantal_gebieden')

# Datasetbewerking
df_grouped = df_grouped.drop(columns=['aantal_gebieden'])
df_grouped = df_grouped.rename(columns={
    'TREG': 'geoitem code',
    'NAME TREG': 'short name'
})
