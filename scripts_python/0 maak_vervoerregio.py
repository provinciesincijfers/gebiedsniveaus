# -*- coding: utf-8 -*-
"""
Created on Mon Aug 11 11:31:59 2025
...
input_path = base_path / "kerntabellen//gemeente_vervoerregio.xlsx"
output_path = base_path / "data_voor_swing//gebiedsdefinities//vervoerregio.xlsx"

# Laad Excel-bestand
col_names = ['gemeente', 'Name gemeente', 'vervoerregio', 'Name vervoerregio']
dtypes = {'gemeente':'Int64', 'Name gemeente': 'string', 'vervoerregio':'Int64', 'Name vervoerregio':'string'} 
...
df_grouped = df.groupby(['vervoerregio', 'Name vervoerregio']).size().reset_index(name='aantal_gebieden')

# Datasetbewerking
df_grouped = df_grouped.drop(columns=['aantal_gebieden'])
df_grouped = df_grouped.rename(columns={
    'vervoerregio': 'geoitem code',
    'Name vervoerregio': 'short name'
})
