# -*- coding: utf-8 -*-
"""
Created on Mon Aug 11 13:27:37 2025
...
input_path = base_path / "kerntabellen//statsec_woningmarkt.xlsx"
output_path = base_path / "data_voor_swing//gebiedsdefinities//woningmarkt.xlsx"

# Laad Excel-bestand
col_names = ['statsec', 'Name statsec', 'woningmarkt', 'Name woningmarkt']
dtypes = {'statsec':'string', 'Name statsec': 'string', 'woningmarkt':'string', 'Name woningmarkt':'string'} 
...
df_grouped = df.groupby(['woningmarkt', 'Name woningmarkt']).size().reset_index(name='aantal_gebieden')

# Datasetbewerking
df_grouped = df_grouped.drop(columns=['aantal_gebieden'])
df_grouped = df_grouped.rename(columns={
    'woningmarkt': 'geoitem code',
    'Name woningmarkt': 'short name'
})
