...
GET DATA
  /TYPE=XLS
  /FILE='C:\github\gebiedsniveaus\kerntabellen\gemeente2024_arrondiss2024.xls'
...
AGGREGATE
  /OUTFILE='arrondiss'
  /BREAK=arrondiss2024 Namebestuurlijkarrondissement2024
  /N_BREAK=N.
dataset activate arrondiss.
delete variables n_break.
rename variables arrondiss2024=gebiedscode.
rename variables Namebestuurlijkarrondissement2024=naam_kort.
string naam (a44).
...
SAVE TRANSLATE OUTFILE='C:\github\gebiedsniveaus\data_voor_swing\gebiedsdefinities\arrondiss2024.xlsx'
  /TYPE=XLS
  /VERSION=12
  /MAP
