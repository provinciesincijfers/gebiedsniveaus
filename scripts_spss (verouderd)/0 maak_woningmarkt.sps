...
AGGREGATE
  /OUTFILE='werkbestand'
  /BREAK=woningmarkt Namewoningmarkt
  /N_BREAK=N.
dataset activate werkbestand.
delete variables n_break.
rename variables woningmarkt=gebiedscode.
rename variables Namewoningmarkt=naam_kort.
string naam (a55).
...
SAVE TRANSLATE OUTFILE='C:\github\gebiedsniveaus\data_voor_swing\gebiedsdefinities\woningmarkt.xlsx'
  /TYPE=XLS
  /VERSION=12
  /MAP
