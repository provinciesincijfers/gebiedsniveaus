...
* verrijken met namen. onerstaande tabel werd gemaakt op basis van de gebiedsdefinitie gemeentenbe2018 in de studio.
GET DATA
  /TYPE=XLSX
...
****tot hier. opgelet bovenstaande staat allemaal nog in temp files.
